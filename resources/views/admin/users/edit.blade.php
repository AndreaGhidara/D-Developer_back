...
<div class="container-fluid my-3">
    <div class="container">
        ...
        <form action="{{ route('admin.users.update', $user ) }}" method="post" class="needs-validation" enctype="multipart/form-data">
            ...
            <div class="col-12 form__group field">
                <input type="date" id="date_of_birth" name="date_of_birth" class="form__field form-control rounded-0 @error('date_of_birth') is-invalid @enderror" id="date_of_birth" name="date_of_birth" value="{{ old("date_of_birth")}}" placeholder="Date of birth" required="" autofocus>
            ...
            <!--INDIRIZZO-->
            <div class="col-12 form__group field">
                <input type="text" id="address" name="address" class="form__field form-control rounded-0 @error('address') is-invalid @enderror" value="{{ old("address")}}" placeholder="Address" required="" autofocus>
            ...
            <!--IMG PROFILE-->
            <div class="col-12 form__group field">
                <input type="file" name="img_path" id="img_path" class="form__field form-control rounded-0 @error('img_path') is-invalid @enderror" placeholder="Profile image" required="" autofocus>
            ...
            {{-- IMG BACKGROUND --}}
            <div class="col-12 form__group field">
                <input id="bg_dev" name="bg_dev" type="file" class="form__field form-control rounded-0 @error('bg_dev') is-invalid @enderror" placeholder="Background image" required="" autofocus>
            ...
            {{-- LINK GITHUB --}}
            <div class="col-12 form__group field">
                <input type="text" id="github_link" name="github_link" class="form__field form-control rounded-0 @error('github_link') is-invalid @enderror" value="{{ old("github_link")  ?? $user->github_link}}" placeholder="Link Github" required="" autofocus>
            ...
            {{-- LINK LINKEDIN --}}
            <div class="col-12 form__group field">
                <input type="text" id="linkedin_link" name="linkedin_link"  class="form__field form-control rounded-0 @error('linkedin_link') is-invalid @enderror" value="{{ old("linkedin_link")  ?? $user->linkedin_link}}" placeholder="Link Linkedin" required="" autofocus>
            ...
            <!--BIO-->
            <div class="col-12 form__group field">
                <textarea type="text" id="bio" name="bio" class="form__field form-control rounded-0 @error('bio') is-invalid @enderror" cols="30" rows="5" placeholder="Bio" required="" autofocus></textarea>
            ...
            {{-- CV --}}
            <div class="col-12 form__group field">
                <input type="file" id="cv" name="cv" class="form__field form-control rounded-0 @error('cv') is-invalid @enderror" placeholder="Curriculum" required="" autofocus>
            ...
            <!-- SOFT SKILLS -->
            <div class="col-12 form__group field">
                <textarea type="text" id="soft_skill" name="soft_skill" class="form__field form-control rounded-0 @error('soft_skill') is-invalid @enderror" cols="30" rows="5" placeholder="Soft Skills" required="" autofocus>{{ old("soft_skill") ?? $user->soft_skill}}</textarea>
