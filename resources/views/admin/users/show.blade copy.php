            ...
            <div class="col-lg-5 p-5 m-3 lightBg rounded-3">
                <div class="row justify-content-center">
                    ...
                    <div class="col-12 justify-center relative">
                        @if ($user->bg_dev)
                            <img src="{{ asset('storage/' . $user->bg_dev) }}" class="border-success border-5 w-100"
                                height="150">
                        @else
                            <img src="https://picsum.photos/1200/600?random" class="border-success border-5 w-100"
                                height="150">
                        @endif
                    </div>
                        ...
                        <div class="col-4 absolute">
                            @if ($user->img_path)
                                <img src="{{ asset('storage/' . $user->img_path) }}"
                                    class="img-fluid rounded-circle border-success border-5">
                            @else
                    ...
                    <div class="row py-2 text-center mt-4 align-items-center">
                        ...
                        {{-- Social e CV --}}
                        <div class="col-lg-6">
                            <a class="mx-1 text-dark" href="{{ asset('storage/' . $user->cv) }}" download="cv">Il mio
                                CV</a>
                            <a class="mx-1" href="{{ $user->github_link }}" target="_blank"><i
                                    class="fa-brands fa-github text-dark"></i></a>
                            <a class="mx-1" href="{{ $user->linkedin_link }}" target="_blank"><i
                                    class="fa-brands fa-linkedin text-dark"></i></a>
                        </div>
                    </div>
                    {{-- Altre info utente --}}
            ...
            <div class="col-lg-5 p-0 m-3">
                        ...
                        @if ($user->programmingLanguages)
                            <ul class="border-0 row justify-content-center p-0">
                                @foreach ($user->programmingLanguages as $language)
                                    <li class="col-lg-3 text-white list-group-item border-0 rounded-4 orangeBg p-1 m-1">
                ...
                <div class="row lightBg rounded-3 p-3 mt-3">
                    <div class="col">
                        <div class="row">
                            <div class="col">
                                <h3 class="text-white orangeBg rounded-5 p-2"><i class="fa-solid fa-book-open-reader"></i>
                                    La tua Bio</h3>
                                <p>{{ $user->bio }}</p>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col">
                                <h3 class="text-white orangeBg rounded-5 p-2"><i class="fa-solid fa-user-gear"></i> Le tue
                                    Soft Skills</h3>
                                <p>{{ $user->soft_skill }}</p>
                            </div>
                        </div>
