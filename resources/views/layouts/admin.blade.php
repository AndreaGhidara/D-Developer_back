                ...
                <div class="menu">
                    <ul class="m-0 p-0">
                            ...
                            <a class="nav-link d-flex align-items-center" href="/">
                                <div class="squereIcon">
                                    <button class="Btn">
                                        ...
                                        <div class="text text-white">Home</div>
                                    </button>
                                </div>
                            </a>
                        </li>
                        ...
                        <li class="d-flex align-items-center py-1">
                          ...
                          {{-- Message --}}
                          <li class="d-flex align-items-center py-1">
                            <a class="nav-link d-flex align-items-center" href="{{ route('admin.users.messages', $user)}}">
                                <div class="squereIcon">
                                    <button class="Btn">
                                        <div class="sign">
                                            {{-- SVG --}}
                        ...
                        {{-- Reviews --}}
                        <li class="d-flex align-items-center py-1">
                            <a class="nav-link d-flex align-items-center" href="{{ route('admin.users.reviews', $user)}}">
                                <div class="squereIcon">
                                    <button class="Btn">
                                        <div class="sign">
                                            {{-- SVG --}}
                        ...
                        {{-- Sponsorships --}}
                        <li class="d-flex align-items-center py-1">
                            <a class="nav-link d-flex align-items-center" href="{{ route('admin.users.sponsorships', $user)}}">
                                <div class="squereIcon">
                                    <button class="Btn">
                                        <div class="sign">
                                            {{-- SVG --}}
                            ...
                            <a class="nav-link d-flex align-items-center" href="{{ route('admin.users.stats', $user)}}">
                                <div class="squereIcon">
                                    <button class="Btn">
                                        ...
                                        <div class="text text-white">Stats</div>
                                    </button>
                                </div>
                            </a>
                        </li>
