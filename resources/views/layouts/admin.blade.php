                ...
                <div class="menu">
                    <ul class="m-0 p-0">
                        ...
                        <li class="d-flex align-items-center py-1">
                            <a class="nav-link d-flex align-items-center" href="http://localhost:5174">
                                <div class="squereIcon coverGlass">
                                    <button class="Btn">
                        ...
                        <li class="d-flex align-items-center py-1">
                            <a class="nav-link d-flex align-items-center"
                                href="{{ route('admin.users.reviews', $user) }}">
                                <div class="squereIcon">
                                    <button class="Btn">
                                        <div class="sign">
                                            {{-- SVG --}}
                        ...
                        <li class="d-flex align-items-center py-1">
                            <a class="nav-link d-flex align-items-center"
                                href="{{ route('admin.users.sponsorships', $user) }}">
                                <div class="squereIcon">
                                    <button class="Btn">
                                        <div class="sign">
                                            {{-- SVG --}}
                                ...
                                <div class="squereIcon">
                                    <button class="Btn">
                                        <div class="sign">
                                            ...
                                            <div class="text"><a class="nav-link text-white"
                                                    href="{{ route('logout') }}"
